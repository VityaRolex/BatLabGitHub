...
int main() {
    ...
    Footbaler* arr[6] = {
        new Footbaler((char*)"Ronaldo", Spec::Attacker, 2027),
        new Footbaler((char*)"Neuer", Spec::Vratar, 2030),
        new Footbaler_in_Arenda((char*)"Mbappe", Spec::Attacker, 2032, 5),
        new Footbaler_in_Arenda((char*)"Alvarez", Spec::Attacker, 2031, 2),
        new Footbaler((char*)"Pique", Spec::Zachitnik, 2025),
        new Footbaler_in_Arenda((char*)"Felix", Spec::Attacker, 2033, 7)
    };
    ...
    std::cout << "Вратарь: " << specCount[Spec::Vratar] << "\n";
    std::cout << "Защитник: " << specCount[Spec::Zachitnik] << "\n";
    std::cout << "Полузащитник: " << specCount[Spec::demi_Zachitnik] << "\n";
    std::cout << "Нападающий: " << specCount[Spec::Attacker] << "\n";
